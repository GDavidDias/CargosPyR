                    ...
                    <div className="flex flex-col border-[5px] border-emerald-500 w-[85%] items-center  ml-[9px] rounded-md shadow-lg bg-emerald-100">
                        ...
                        <div className="flex flex-col items-end text-2xl">
                            ...
                            <div className="flex flex-row my-[2px]">
                                ...
                                <div className="flex items-center border-[1px]  border-zinc-300 rounded w-[20vw] h-[6vh] pl-[4px] bg-neutral-50 text-sm">{datosVacanteSelect.hasta_observacion ?datosVacanteSelect.hasta_observacion :"" } </div>
                                {/*<div className="flex items-center border-[1px]  border-zinc-300 rounded w-[20vw] h-[6vh] pl-[4px] bg-neutral-50 text-sm">{datosVacanteSelect.hasta ?datosVacanteSelect.hasta.replace(/\d{2}:\d{2}:\d{2}$/, "").trim() :""}</div>*/}
